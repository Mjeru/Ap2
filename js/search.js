			...
			/***/ function (module, exports) {
				function mf_open_window(url) {
					...
					if (width > 1240 && height > 840) {
						params =
							"left=20,top=20,width=1200,height=800,menubar=no,location=no,status=no,titlebar=no";
					}
				...
				/* WEBPACK VAR INJECTION */ (function (jQuery, $) {
					...
					!(function (e) {
						...
						function r(o) {
							...
							return (
								e[o].call(a.exports, a, a.exports, r), (a.l = !0), a.exports
							);
						}
						...
						"3ara": function ara(e, t) {
							...
							(o = jQuery),
								(a = {
									...
									errors: {
										tpl:
											'<div class="arcticmodal-error arcticmodal-close"></div>',
										autoclose_delay: 2e3,
									...
									return (
										o(e).each(function () {
											o(t.target).get(0) == o(this).get(0) && (r = !1),
												0 ==
													o(t.target).closest("HTML", o(this).get(0)).length &&
													(r = !1);
										}),
										r
									);
								...
								(l = {
														...
														e.trigger("errorLoading"),
															...
															null == f
																? (r.body.html(r.errors.tpl),
																  ...
																  o(".arcticmodal-close", r.body).click(
																		function () {
									...
									init: function init(e) {
										...
										if (null == e)
											o.error("jquery.arcticmodal: Uncorrect parameters");
										else if ("" == e.type)
											o.error(
											...
											switch (e.type) {
												...
												case "ajax":
													if ("" == e.url) {
														o.error(
															'jquery.arcticmodal: Don\'t set parameter "url"'
														);
														break;
													}
														...
														l.transition(
															...
															function () {
																t.afterClose(t, e),
																	...
																	t.clone ||
																		o(
																			"#arcticmodalReserve" + t.modalID
																		).replaceWith(t.body.find(">*")),
								...
								(o.arcticmodal = o.fn.arcticmodal = function (e) {
									return d[e]
										...
										: "object" !== r(e) && e
										? void o.error(
												"jquery.arcticmodal: Method " + e + " does not exist"
										  )
			...
			/***/ function (module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */ (function ($) {
					$(document).ready(function () {
						...
						var subMenuParent = document.querySelectorAll(
							".js-page-menu-submenu-parent"
						);
						var urlGeo = document.querySelector(".js-mf-search-url-geo")
							.textContent;
						...
						$(".tostyle").each(function (index) {
							...
							if ($(this).hasClass("mf-search-popup-disabled-select")) {
								$this.after(
									'<div class="mf-search-select-styled mf-search-popup-disabled-select"></div>'
								);
							} else {
							...
							$styledSelect.click(function (e) {
								...
								$("div.mf-search-select-styled.active")
									.not(this)
									.each(function () {
										$(this)
											.removeClass("active")
							...
							document
								...
								.addEventListener("input", function (e) {
									...
									if (e.target.value !== "") {
										document.querySelector(".mf-search-clear-input").style =
											"opacity: 1;";
									} else {
										document.querySelector(".mf-search-clear-input").style =
											"opacity: 0.5;";
						...
						[].forEach.call(
							document.querySelectorAll(".mf-search-clear-input"),
							function (element) {
								element.onclick = function (e) {
									[].forEach.call(e.target.parentNode.children, function (
										element
									) {
							...
							element.onclick = function (e) {
								...
								if (!e.target.classList.contains("droped") == true) {
									if (e.target.classList.contains("search__drop")) {
										...
										e.target.classList.add("mf-search-parent-hover");
										document
											.querySelector(".js-search-form-filter-menu")
						...
						document.querySelector(".js-search-form-filter-menu").onclick = (
							e
						) => {
							document
								.querySelector(".js-search-form-filter-menu")
						...
						country.onchange = function (e) {
							...
							if (
								!street.classList.contains("mf-search-popup-disabled-select")
							) {
								street.classList.add("mf-search-popup-disabled-select");
							}

							if (
								!district.classList.contains("mf-search-popup-disabled-select")
							) {
...
*/
					...
					function callback(event) {
						...
						event.target.parentNode.children[0].children[0].innerHTML =
							event.item.index + 1;
						event.target.parentNode.children[0].children[1].innerHTML =
							event.item.count;
					}
					/* WEBPACK VAR INJECTION */
				}.call(
						...
						(b.prototype = {
									...
									(d.killerFn = function (b) {
										0 ===
											a(b.target).closest("." + d.options.containerClass)
												.length && (d.killSuggestions(), d.disableKillerFn());
									}),
							...
							signalHint: function signalHint(b) {
								var c = "",
									d = this;
								b &&
									(c = d.currentValue + b.value.substr(d.currentValue.length)),
									d.hintValue !== c &&
										((d.hintValue = c),
										(d.hint = b),
  ...
  \********************************************************************************************************************************************************************************************************************************************************************/
			...
			/***/ function (module, exports, __webpack_require__) {
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\click.js */ "./resources/assets/js/click.js"
				);
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\jquery.autocomplete.min.js */ "./resources/assets/js/search/jquery.autocomplete.min.js"
				);
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\all.js */ "./resources/assets/js/search/all.js"
				);
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\slider.js */ "./resources/assets/js/search/slider.js"
				);
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\jquery.mask.min.js */ "./resources/assets/js/search/jquery.mask.min.js"
				);
				module.exports = __webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\form.js */ "./resources/assets/js/search/form.js"
				);
