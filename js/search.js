...
/***/ "./resources/assets/js/search/all.js":
/*!*******************************************!*\
  !*** ./resources/assets/js/search/all.js ***!
  \*******************************************/
/*! no static exports found */
...
!function (e) {
  ...
  "3ara": function ara(e, t) {
    ...
    o = jQuery, a = {
      ...
      errorLoading: o.noop
    }, n = 0, c = o([]), i = function i(e, t) {
      var r = !0;
      return o(e).each(function () {
        o(t.target).get(0) == o(this).get(0) && (r = !1), 0 == o(t.target).closest("HTML", o(this).get(0)).length && (r = !1);
      }), r;
    }, l = {
      getParentEl: function getParentEl(e) {
        var t = o(e);
        return (t.data("arcticmodal") || !!(t = o(e).closest(".arcticmodal-container").data("arcticmodalParentEl"))) && t;
      },
      transition: function transition(e, t, r, a) {
      ...
      prepare_body: function prepare_body(e, t) {
        o(".arcticmodal-close", e.body).unbind("click.arcticmodal").bind("click.arcticmodal", function () {
          return t.arcticmodal("close"), !1;
        });
      },
      init_el: function init_el(e, t) {
        var r = e.data("arcticmodal");

        if (!r) {
          if (n++, (r = t).modalID = n, r.overlay.block = o(r.overlay.tpl), r.overlay.block.css(r.overlay.css), r.container.block = o(r.container.tpl), r.body = o(".arcticmodal-container_i2", r.container.block), t.clone ? r.body.html(e.clone(!0)) : (e.before('<div id="arcticmodalReserve' + r.modalID + '" style="display: none" />'), r.body.html(e)), l.prepare_body(r, e), r.closeOnOverlayClick && r.overlay.block.add(r.container.block).click(function (t) {
            i(o(">*", r.body), t) && e.arcticmodal("close");
          }), r.container.block.data("arcticmodalParentEl", e), e.data("arcticmodal", r), c = o.merge(c, e), o.proxy(d.show, e)(), "html" == r.type) return e;
          ...
          var u = o.extend(!0, {
            ...
            beforeSend: function beforeSend() {
              null == a ? r.body.html('<div class="arcticmodal-loading" />') : a(r, e);
            },
            success: function success(t) {
              e.trigger("afterLoading"), r.afterLoading(r, e, t), null == s ? r.body.html(t) : s(r, e, t), l.prepare_body(r, e), e.trigger("afterLoadingOnShow"), r.afterLoadingOnShow(r, e, t);
            },
            error: function error() {
              e.trigger("errorLoading"), r.errorLoading(r, e), null == f ? (r.body.html(r.errors.tpl), o(".arcticmodal-error", r.body).html(r.errors.ajax_unsuccessful_load), o(".arcticmodal-close", r.body).click(function () {
                return e.arcticmodal("close"), !1;
              }), r.errors.autoclose_delay && setTimeout(function () {
                e.arcticmodal("close");
              }, r.errors.autoclose_delay)) : f(r, e);
            }
          }, r.ajax);
      ...
      init: function init(e) {
        if (e = o.extend(!0, {}, a, e), !o.isFunction(this)) return this.each(function () {
          l.init_el(o(this), o.extend(!0, {}, e));
        });
        if (null == e) o.error("jquery.arcticmodal: Uncorrect parameters");else if ("" == e.type) o.error('jquery.arcticmodal: Don\'t set parameter "type"');else switch (e.type) {
          case "html":
            if ("" == e.content) {
      ...
      show: function show() {
        ...
        if (!1 !== e) {
          ...
          if (t.overlay.block.hide(), t.container.block.hide(), o("BODY").append(t.overlay.block), o("BODY").append(t.container.block), t.beforeOpen(t, e), e.trigger("beforeOpen"), "hidden" != t.wrap.css("overflow")) {
          ...
          }), l.transition(t.overlay.block, "show", 1 < c.length ? {
            type: "none"
          } : t.openEffect), l.transition(t.container.block, "show", 1 < c.length ? {
            type: "none"
      ...
      close: function close() {
        if (!o.isFunction(this)) return this.each(function () {
          var e = l.getParentEl(this);
          if (!1 === e) o.error("jquery.arcticmodal: Uncorrect call");else {
            var t = e.data("arcticmodal");
            !1 !== t.beforeClose(t, e) && (e.trigger("beforeClose"), c.not(e).last().each(function () {
              o(this).data("arcticmodal").overlay.block.show();
            }), l.transition(t.overlay.block, "hide", 1 < c.length ? {
              type: "none"
            } : t.closeEffect), l.transition(t.container.block, "hide", 1 < c.length ? {
              type: "none"
            } : t.closeEffect, function () {
              t.afterClose(t, e), e.trigger("afterClose"), t.clone || o("#arcticmodalReserve" + t.modalID).replaceWith(t.body.find(">*")), t.overlay.block.remove(), t.container.block.remove(), e.data("arcticmodal", null), o(".arcticmodal-container").length || (t.wrap.data("arcticmodalOverflow") && t.wrap.css("overflow", t.wrap.data("arcticmodalOverflow")), t.wrap.css("marginRight", 0));
      ...
      return d[e] ? d[e].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" !== r(e) && e ? void o.error("jquery.arcticmodal: Method " + e + " does not exist") : l.init.apply(this, arguments);
    };
  },
  OMIv: function OMIv(e, t) {
    var r,
        o,
        a = ["click", "[data-sendfirmdata]", "removeClass", ".firm-city", "removeChild", ".firm-date", "autocomplete", "before", "getElementById", "css", ".footer", ".firm-desc", "container-ie8", "documentElement", ".top-firms-container", "createElement", ".home-link", "after", "isArray", ".lang-block", ']><b id="iecctest"></b><![endif]--\x3e', "join", "attr", "resize", "find", ".search-field", ".container", "suggestions", "hover", "width", "blur", "#modal", ".add-firm", "focus", " - ", "each", "lte", "query", ".firm-counter", ".firm-name", "trim", "appendChild", "lclosed2", "addClass", "arcticmodal", ".firms > div", "ontouchstart", ".search-form button", "placeholder", "small-search-button", "parse", "hide", ".lang-block .act", "show", "val"];
    r = a, o = 314, function (e) {
      for (; --e;) {
        r.push(r.shift());
      }
    }(++o);
    ...
    $(function () {
      ...
      function e(e, t) {
        var r,
            ...
            a = document[n("0x1f")]("B"),
            c = document[n("0x1d")];
        return e && (o += " " + e, t && (o = t + " " + o)), a.innerHTML = "\x3c!--[if " + o + n("0x24"), c[n("0x2")](a), r = !!document[n("0x18")]("iecctest"), c[n("0x14")](a), r;
      }
      ...
      var t = e(8),
          ...
          c = $(n("0x8"));
      a = $(n("0x30"));
      e(9, n("0x34")) && o[n("0x2e")](function () {
        var e = $(this);
        $[n("0x1")](e[n("0xf")]()) || e.val(e[n("0x26")](n("0x9")));
      })[n("0x31")](function () {
        var e = $(this);
        $[n("0x1")](e[n("0xf")]()) == e[n("0x26")](n("0x9")) && e[n("0xf")]("");
      }), o[n("0x16")]({
        serviceUrl: n("0x35"),
        minChars: 1,
        transformResult: function transformResult(e) {
      ...
      }), t && $(n("0x2a")).addClass(n("0x1c")), r[n("0x27")](function () {
        var e = r[n("0x2d")]();
        e < 640 ? (o[n("0x19")](n("0x2d"), e - (t ? 190 : 140) + "px"), a[n("0xc")](), t || (c[n("0x4")](n("0xa")), $(n("0x6"))[n("0x33")](function (e, t) {
          (t = $(t))[n("0x28")](n("0x13")).before(t[n("0x28")](n("0x15"))), t.find(n("0x36"))[n("0x17")](t[n("0x28")](n("0x0")));
        }))) : (o[n("0x19")](n("0x2d"), e - 190 + "px"), a[n("0xe")](), t || (c.removeClass(n("0xa")), $(n("0x6"))[n("0x33")](function (e, t) {
          (t = $(t))[n("0x28")](n("0x1b"))[n("0x17")](t.find(n("0x0"))), t[n("0x28")](n("0x36"))[n("0x21")](t.find(n("0x15")));
        })));
      })[n("0x27")](), $(n("0x11"))[n("0x10")](function () {
        $(n("0x2f"))[n("0x5")]();
      });
...
$(document).ready(function () {
  $('.mf-search-mobile-button').click(function () {
    $('.mf-search-form-block').toggle('display');
    $('.mf-search-mobile-block').toggle('display');
  });
  $('.mf-expand-images').click(function () {
    var thisData = $(this);
    $('.mf-ellipsis-' + thisData.attr("data-id")).hide();
    $('.mf-images-' + thisData.attr("data-id")).show();
  });
  $('.mf-expand-images').hover(function () {
    var thisData = $(this);
    $('.mf-ellipsis-' + thisData.attr("data-id")).hide();
    $('.mf-images-' + thisData.attr("data-id")).show();
  });
  var subMenuParent = document.querySelectorAll(".js-page-menu-submenu-parent");
  var urlGeo = document.querySelector(".js-mf-search-url-geo").textContent;
  [].forEach.call(subMenuParent, function (element) {
    element.onmouseenter = function (e) {
      e.target.classList.add("mf-search-parent-hover");
    ...
    element.onmouseleave = function (e) {
      e.target.classList.remove("mf-search-parent-hover");
      [].forEach.call(e.target.children, function (element) {
        if (element.tagName == "UL") {
  ...
  $(".tostyle").each(function (index) {
    ...
    var dropClass = "";
    $this.addClass("mf-search-select-hidden");
    $this.wrap('<div class="select"></div>');

    if ($(this).hasClass("mf-search-popup-disabled-select")) {
      $this.after('<div class="mf-search-select-styled mf-search-popup-disabled-select"></div>');
    } else {
      $this.after('<div class="mf-search-select-styled"></div>');
    }

    var $styledSelect = $this.next("div.mf-search-select-styled");
    ...
    $styledSelect.click(function (e) {
      ...
      $("div.mf-search-select-styled.active").not(this).each(function () {
    ...
    $listItems.click(function (e) {
      ...
      if ($(this).text() == "...") {
        $this.val("");
        $styledSelect.text($(this).parent().children().first().text()).removeClass("active");
        $list.hide();
        return;
      } else {
    ...
    document.querySelector(".whith-clear").addEventListener("input", function (e) {
      e.target.value;

      if (e.target.value !== "") {
        document.querySelector(".mf-search-clear-input").style = "opacity: 1;";
      } else {
        document.querySelector(".mf-search-clear-input").style = "opacity: 0.5;";
      }
    });
  });
  ...
  [].forEach.call(document.querySelectorAll(".mf-search-clear-input"), function (element) {
    ...
    element.onclick = function (e) {
      ...
      if (!e.target.classList.contains("droped") == true) {
        if (e.target.classList.contains("search__drop")) {
          if (document.querySelectorAll(".droped").length > 0 && !e.target.classList.contains("droped")) {
            document.querySelector(".droped").click();
          }

          e.target.classList.add("mf-search-parent-hover");
          document.querySelector(".js-search-form-filter-menu").classList.toggle("disp");
        }
  ...
  document.querySelector(".js-search-form-filter-menu").onclick = (e) => {
	document.querySelector(".js-search-form-filter-menu").classList.remove("disp");
	document.querySelector(".droped").click();
	document.querySelector(".js-search-form-filter-menu").classList.toggle("disp");
};
  [].forEach.call(document.querySelectorAll(".filter-label-link"), function (element) {
    element.onclick = function (e) {
  ...
  (function () {
    function disableScroll() {
      ...
      document.body.style.paddingRight = padding + "px"; //document.querySelector(".header").style.paddingRight = padding + "px";
    }

    function enableScroll() {
      var pagePosition = parseInt(document.querySelector(".lock").dataset.position, 10);
      ...
      document.body.removeAttribute("style"); //document.querySelector(".header").removeAttribute("style");
    }
    ...
    $(".mf-search-popup-close").on("click", function (e) {
      $(".popup").animate({
        opacity: 0
      }, 200, "linear");
      $(".popup-overlay").animate({
  ...
  country.onchange = function (e) {
    ...
    if (!street.classList.contains("mf-search-popup-disabled-select")) {
      street.classList.add("mf-search-popup-disabled-select");
    }

    if (!district.classList.contains("mf-search-popup-disabled-select")) {
      district.classList.add("mf-search-popup-disabled-select");
    }

    if (value == "") {
      region.classList.add("mf-search-popup-disabled-select");
      city.classList.add("mf-search-popup-disabled-select");
      district.classList.add("mf-search-popup-disabled-select");
      street.classList.add("mf-search-popup-disabled-select");
      house.classList.add("mf-search-popup-disabled-select");
      return;
    }
    ...
    $.ajax({
      ...
      success: function success(html) {
        ...
        region.classList.remove("mf-search-popup-disabled-select");
      }
    });
    $.ajax({
      url: "".concat(urlGeo, "?type=city&country=").concat(country.value, '&region=""'),
      context: document.body,
      success: function success(html) {
        html.list.forEach(function (element) {
          var newLi = document.createElement("option");
        ...
        city.classList.remove("mf-search-popup-disabled-select");
      }
    });
  };
  ...
  region.onchange = function (e) {
    ...
    if (!street.classList.contains("mf-search-popup-disabled-select")) street.classList.add("mf-search-popup-disabled-select");
    if (!district.classList.contains("mf-search-popup-disabled-select")) district.classList.add("mf-search-popup-disabled-select");
    city.appendChild(blunk.cloneNode());
    console.log("".concat(urlGeo, "?type=city&country=").concat(country.value, "&region=").concat(value));
    $.ajax({
      url: "".concat(urlGeo, "?type=city&country=").concat(country.value, "&region=").concat(value),
      context: document.body,
      success: function success(html) {
        html.list.forEach(function (element) {
          var newLi = document.createElement("option");
  ...
  city.onchange = function (e) {
    ...
    $.ajax({
      url: "".concat(urlGeo, "?type=district&country=").concat(country.value, "&region=").concat(region.value, "&city=").concat(value),
      context: document.body,
      success: function success(html) {
        html.list.forEach(function (element) {
          var newLi = document.createElement("option");
        ...
        district.classList.remove("mf-search-popup-disabled-select");
      }
    });
    $.ajax({
      url: "".concat(urlGeo, "?type=street&country=").concat(country.value, "&region=").concat(region.value, "&city=").concat(city.value, "&district=").concat(value),
      context: document.body,
      success: function success(html) {
        html.list.forEach(function (element) {
          var newLi = document.createElement("option");
        ...
        street.classList.remove("mf-search-popup-disabled-select");
      }
    });
  };
  ...
  street.onchange = function (e) {
    ...
    $.ajax({
      url: "".concat(urlGeo, "?type=house&country=").concat(country.value, "&region=").concat(region.value, "&city=").concat(city.value, "&district=").concat(district.value, "&street=").concat(value),
      context: document.body,
      success: function success(html) {
        html.list.forEach(function (element) {
          var newLi = document.createElement("option");
        ...
        house.classList.remove("mf-search-popup-disabled-select");
      }
    });
  };

  $(".min_price").mask("000'000'000'000'000", {
    reverse: true
  });
  $(".max_price").mask("000'000'000'000'000", {
    reverse: true
  });
...
function callback(event) {
  ...
  event.target.parentNode.children[0].children[0].innerHTML = event.item.index + 1;
  event.target.parentNode.children[0].children[1].innerHTML = event.item.count;
}
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "./node_modules/jquery/dist/jquery.js")))

/***/ }),

/***/ "./resources/assets/js/search/jquery.autocomplete.min.js":
/*!***************************************************************!*\
  !*** ./resources/assets/js/search/jquery.autocomplete.min.js ***!
  \***************************************************************/
/*! no static exports found */
...
!function (a) {
  ...
  function b(c, d) {
    var e = function e() {},
      ...
      preventBadQueries: !0,
      lookupFilter: function lookupFilter(a, b, c) {
        return -1 !== a.value.toLowerCase().indexOf(c);
      },
      paramName: "query",
      transformResult: function transformResult(b) {
  ...
  b.utils = c, a.Autocomplete = b, b.formatResult = function (a, b) {
    ...
    findSuggestionIndex: function findSuggestionIndex(b) {
      var c = this,
          d = -1,
          e = b.toLowerCase();
...
/***/ "./resources/assets/js/search/jquery.mask.min.js":
/*!*******************************************************!*\
  !*** ./resources/assets/js/search/jquery.mask.min.js ***!
  \*******************************************************/
/*! no static exports found */
...
/***/ "./resources/assets/js/search/slider.js":
/*!**********************************************!*\
  !*** ./resources/assets/js/search/slider.js ***!
  \**********************************************/
/*! no static exports found */
...
/***/ 1:
/*!********************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./resources/assets/js/click.js ./resources/assets/js/search/jquery.autocomplete.min.js ./resources/assets/js/search/all.js ./resources/assets/js/search/slider.js ./resources/assets/js/search/jquery.mask.min.js ./resources/assets/js/search/form.js ***!
  \********************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\click.js */"./resources/assets/js/click.js");
__webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\jquery.autocomplete.min.js */"./resources/assets/js/search/jquery.autocomplete.min.js");
__webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\all.js */"./resources/assets/js/search/all.js");
__webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\slider.js */"./resources/assets/js/search/slider.js");
__webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\jquery.mask.min.js */"./resources/assets/js/search/jquery.mask.min.js");
module.exports = __webpack_require__(/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\search\form.js */"./resources/assets/js/search/form.js");
