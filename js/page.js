  ...
  \********************************************/
	...
	---------------------------------------------------------------------- */
		...
		*/
		...
		/***/ "./resources/assets/js/page/lang.js":
			/*!******************************************!*\
  !*** ./resources/assets/js/page/lang.js ***!
  \******************************************/
			/*! no static exports found */
			/***/ function (module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */ (function ($) {
					$(document).ready(function () {
						var langBlock = document.querySelector(".page-lang-block");
						var langWidth = document.querySelector(".page-lang-options")
							.offsetWidth;
						var langHeigth = $(".page-lang-options").height();
						var options = document.querySelector(".page-lang-options");

						document.querySelector(".js-page-lang-menu").onclick = function (
							e
						) {
							if (options.offsetWidth > 1) {
								$(".page-lang-options").animate(
									{
										width: "1px",
									},
									100,
						...
						document.querySelector(".js-page-lang-menu").onclick();
						window.setTimeout(function () {
							langBlock.style.opacity = 1;
						}, 300);

						document.querySelector(
							".page-lang-block-close"
						).onclick = function (e) {
							document
								.querySelector(".page-lang-block-close")
								.classList.remove("disp");
							...
							if (
								document.querySelector(".page-lang-block").offsetWidth > 150
							) {
						...
						$(".js-page-lang-select2").each(function (index) {
							var $this = $(this),
								numberOfOptions = $(this).children("option").length;
							var dropClass = "";
							$this.addClass("mf-search-select-hidden");
		...
		/***/ "./resources/assets/js/page/menu.js":
			/*!******************************************!*\
  !*** ./resources/assets/js/page/menu.js ***!
  \******************************************/
			/*! no static exports found */
			/***/ function (module, exports, __webpack_require__) {
				...
				/* WEBPACK VAR INJECTION */ (function ($) {
					$(document).ready(function () {
						...
						[].forEach.call(document.querySelectorAll(".subsub"), function (
							el
						) {
		...
		/***/ 0:
			/*!***********************************************************************************!*\
  !*** multi ./resources/assets/js/page/menu.js ./resources/assets/js/page/lang.js ***!
  \***********************************************************************************/
			/*! no static exports found */
			/***/ function (module, exports, __webpack_require__) {
				__webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\page\menu.js */ "./resources/assets/js/page/menu.js"
				);
				module.exports = __webpack_require__(
					/*! d:\Soft\OSPanel\domains\manyflats.com\resources\assets\js\page\lang.js */ "./resources/assets/js/page/lang.js"
				);
